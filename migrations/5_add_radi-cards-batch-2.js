...
module.exports = async (deployer, network, accounts) => {
  ...
  await contract.addCard(3, "QmQdNgFnmfKnWjYF6bvfH67f2rLLa74eTBQLWzozfdKfmo", true, {from: account}); // FU -stars
  await contract.addCard(4, "QmP8USgWUrihWfyhy7CNakcDbtkVPfJYKuZd9hcikP26QD", true, {from: account}); // Stina - bird
  await contract.addCard(5, "QmTT82fZU1TTfcEWfiLP4HNbjGbsHJFh2uNwjUsveAYfnS", true, {from: account}); // hex - xstars
};
